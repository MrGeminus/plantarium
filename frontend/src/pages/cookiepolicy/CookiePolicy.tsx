...
const CookiePolicy = () => {
    return (
        <main id="main" className="flex-grow-1 py-5">
            ...
            <ul>
                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Plantarium D.O.O., Bulevar Oslobodjenja 35, 21209 Novi Sad, Serbia.</li>
                <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                <li><strong>Website</strong> refers to Plantarium, accessible from <a href="http://www.plantarium.com" rel="external nofollow noopener" target="_blank">http://www.plantarium.com</a></li>
            ...
            <ul>
                <li>By visiting this page on our website: <a href="http://plantarium.com/en/contact" rel="external nofollow noopener" target="_blank">http://plantarium.com/en/contact</a></li>
            </ul>
        </main>
    );
}
